...
print("single value tuple is: ",single_val_tup)

"""3.create one number element tuple and square all the elements in that tuple and stores in new list."""
...
b = 30
c = 40
t = a,b,c #packing of tuple
print(type(t))
print(t)
x,y,z = t #unpacking of tuple
print("x: ",x)
print("y: ",y)
print("z: ",z)
...
t1 = (1,2,3,4,5)
print("t1: ",t1)
#t1[0] = 100 """tuples are immutable we cant add"""
#print("updated t1: ",t1)
...
"""13.write a program to convert to calculate the product,multiplying all the numbers in a given tuple."""
num_tuple = tuple(range(1,11))
print("number tuple is: ",num_tuple)
m = 1
for num in num_tuple:
    m *= num
print("multiplication all numbers: ",m)
